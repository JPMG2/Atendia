...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            // Explicit so a freshly made instance carries the attribute: the
            // shell reads user->business on every screen, and strict models
            // throw on an attribute create() never set.
            'business_id' => null,
        ];
    }
