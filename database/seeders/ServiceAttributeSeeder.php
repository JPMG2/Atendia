...
{
    /**
     * La biblioteca de atributos con la que arranca el maestro.
     *
     * Son GLOBALES y reutilizables a propósito: `Foto` es el mismo atributo en un
     * plato de restaurante y en un producto de kiosko. Cuál lleva cada tipo de
     * servicio lo dice `service_type_attribute`; acá se define el campo una vez.
     *
     * NO están `precio`, `stock` ni `duracion`: son campos de PRIMERA CLASE de lo
     * que adopta el negocio, no atributos genéricos. Se consultan, ordenan y
     * actualizan en masa, y necesitan moneda, transacciones y agenda — dentro de
     * un jsonb genérico nada de eso se puede resolver. Ver la migración
     * `drop_first_class_service_attributes`.
     *
    ...
    {
        $attributes = [
            // Transversales: los usa casi cualquier oficio.
