...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.service_attribute.search_placeholder')"
            :search-label="__('catalog.service_attribute.search_label')"
            :singular="__('catalog.service_attribute.singular')"
            :plural="__('catalog.service_attribute.plural')"
            :create="__('catalog.service_attribute.create')"
        />

        <x-catalog.table
            :empty="__('catalog.service_attribute.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.service_attribute.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.service_attribute.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.service_attribute.new')"
        ...
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.service_attribute.fields.code')"
                    required
                    name="code"
                    :hint="__('catalog.service_attribute.fields.code_hint')"
                    maxlength="40"
                    alpine-error="code"
                ...
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.service_attribute.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.service_attribute.fields.name_placeholder')"
                    alpine-error="name"
                ...
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.service_attribute.fields.data_type')"
                    required
                    name="data_type"
                    :placeholder="__('catalog.service_attribute.fields.data_type_placeholder')"
                    :hint="__('catalog.service_attribute.fields.data_type_hint')"
                    :options="$this->dataTypeOptions"
                    :value="$form->data?->data_type"
                    alpine-error="data_type"
                    wire:model="form.data.data_type"
                />
            </x-catalog.form-row>
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="long"
                    :label="__('catalog.service_attribute.fields.description')"
                    name="description"
                    :placeholder="__('catalog.service_attribute.fields.description_placeholder')"
                    :hint="__('catalog.service_attribute.fields.description_hint')"
                    maxlength="255"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.service_attribute.fields.unit')"
                    name="unit"
                    :placeholder="__('catalog.service_attribute.fields.unit_placeholder')"
                    :hint="__('catalog.service_attribute.fields.unit_hint')"
                    maxlength="15"
                    alpine-error="unit"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.service_attribute.fields.order')"
                    name="sort_order"
                    type="number"
                    min="0"
                    max="32767"
                    :hint="__('catalog.service_attribute.fields.order_hint')"
                ...
                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.service_attribute.fields.multiple')"
                    name="is_multiple"
                    :on="__('catalog.service_attribute.multiple.on')"
                    :off="__('catalog.service_attribute.multiple.off')"
                    wire:model="form.data.is_multiple"
                />

                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.service_attribute.fields.status')"
                    name="is_active"
                    :on="__('catalog.service_attribute.status.active')"
                    :off="__('catalog.service_attribute.status.inactive')"
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="full"
                    :label="__('catalog.service_attribute.fields.options')"
                    name="options"
                    :placeholder="__('catalog.service_attribute.fields.options_placeholder')"
                    :hint="__('catalog.service_attribute.fields.options_hint')"
                    maxlength="500"
                    alpine-error="options"
