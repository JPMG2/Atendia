...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.business_activity.search_placeholder')"
            :search-label="__('catalog.business_activity.search_label')"
            :singular="__('catalog.business_activity.singular')"
            :plural="__('catalog.business_activity.plural')"
            :create="__('catalog.business_activity.create')"
        />

        <x-catalog.table
            :empty="__('catalog.business_activity.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.business_activity.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.business_activity.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.business_activity.new')"
        ...
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.business_activity.fields.code')"
                    required
                    name="code"
                    :hint="__('catalog.business_activity.fields.code_hint')"
                    maxlength="40"
                    alpine-error="code"
                ...
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.business_activity.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.business_activity.fields.name_placeholder')"
                    alpine-error="name"
            ...
            <x-catalog.form-row>
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.business_activity.fields.sector')"
                    required
                    name="business_sector_id"
                    :placeholder="__('catalog.business_activity.fields.sector_placeholder')"
                ...
                <x-inputsform.input
                    span="long"
                    :label="__('catalog.business_activity.fields.description')"
                    name="description"
                    :placeholder="__('catalog.business_activity.fields.description_placeholder')"
                    :hint="__('catalog.business_activity.fields.description_hint')"
                    maxlength="255"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.business_activity.fields.order')"
                    name="sort_order"
                    type="number"
                    min="0"
                    max="32767"
                    :hint="__('catalog.business_activity.fields.order_hint')"
                ...
                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.business_activity.fields.status')"
                    name="is_active"
                    :on="__('catalog.business_activity.status.active')"
