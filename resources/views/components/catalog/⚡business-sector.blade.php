...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.business_sector.search_placeholder')"
            :search-label="__('catalog.business_sector.search_label')"
            :singular="__('catalog.business_sector.singular')"
            :plural="__('catalog.business_sector.plural')"
            :create="__('catalog.business_sector.create')"
        />

        <x-catalog.table
            :empty="__('catalog.business_sector.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.business_sector.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.business_sector.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.business_sector.new')"
            :new-title="__('catalog.business_sector.new_title')"
            :edit-title="__('catalog.business_sector.edit_title')"
            :create="__('catalog.business_sector.create')"
            title-key="name"
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.business_sector.fields.code')"
                    required
                    name="code"
                    :hint="__('catalog.business_sector.fields.code_hint')"
                    maxlength="30"
                    alpine-error="code"
                ...
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.business_sector.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.business_sector.fields.name_placeholder')"
                    alpine-error="name"
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="long"
                    :label="__('catalog.business_sector.fields.description')"
                    name="description"
                    :placeholder="__('catalog.business_sector.fields.description_placeholder')"
                    :hint="__('catalog.business_sector.fields.description_hint')"
                    maxlength="255"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.business_sector.fields.order')"
                    name="sort_order"
                    type="number"
                    min="0"
                    max="32767"
                    :hint="__('catalog.business_sector.fields.order_hint')"
                ...
                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.business_sector.fields.status')"
                    name="is_active"
                    :on="__('catalog.business_sector.status.active')"
