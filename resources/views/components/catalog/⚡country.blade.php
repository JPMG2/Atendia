...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.country.search_placeholder')"
            :search-label="__('catalog.country.search_label')"
            :singular="__('catalog.country.singular')"
            :plural="__('catalog.country.plural')"
            :create="__('catalog.country.create')"
        />

        <x-catalog.table
            :empty="__('catalog.country.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.country.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.country.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.country.new')"
            :new-title="__('catalog.country.new_title')"
            :edit-title="__('catalog.country.edit_title')"
            :create="__('catalog.country.create')"
            title-key="code"
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.country.fields.code')"
                    required
                    name="code"
                    :hint="__('catalog.country.fields.code_hint')"
                    maxlength="3"
                    alpine-error="code"
                    x-mask="aaa"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.country.fields.iso2')"
                    required
                    name="iso2"
                    :hint="__('catalog.country.fields.iso2_hint')"
                    maxlength="2"
                    alpine-error="iso2"
                    x-mask="aa"
                    style="text-transform: uppercase"
                ...
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.country.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.country.fields.name_placeholder')"
                    alpine-error="name"
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.country.fields.phone_code')"
                    name="phone_code"
                    :hint="__('catalog.country.fields.phone_code_hint')"
                    maxlength="6"
                ...
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.country.fields.currency')"
                    required
                    name="currency_id"
                    :placeholder="__('catalog.country.fields.currency_placeholder')"
                ...
                <x-inputsform.switch-field
                    span="text"
                    :label="__('catalog.country.fields.status')"
                    name="is_active"
                    :on="__('catalog.country.status.active')"
                    :off="__('catalog.country.status.inactive')"
