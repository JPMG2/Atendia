...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.province.search_placeholder')"
            :search-label="__('catalog.province.search_label')"
            :singular="__('catalog.province.singular')"
            :plural="__('catalog.province.plural')"
            :create="__('catalog.province.create')"
        />

        <x-catalog.table
            :empty="__('catalog.province.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.province.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.province.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.province.new')"
            :new-title="__('catalog.province.new_title')"
            :edit-title="__('catalog.province.edit_title')"
            :create="__('catalog.province.create')"
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.province.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.province.fields.name_placeholder')"
                    alpine-error="name"
                ...
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.province.fields.country')"
                    required
                    name="country_id"
                    :placeholder="__('catalog.province.fields.country_placeholder')"
                ...
                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.province.fields.status')"
                    name="is_active"
                    :on="__('catalog.province.status.active')"
                    :off="__('catalog.province.status.inactive')"
