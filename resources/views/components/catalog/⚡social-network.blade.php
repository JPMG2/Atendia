...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.social_network.search_placeholder')"
            :search-label="__('catalog.social_network.search_label')"
            :singular="__('catalog.social_network.singular')"
            :plural="__('catalog.social_network.plural')"
            :create="__('catalog.social_network.create')"
        />

        <x-catalog.table
            :empty="__('catalog.social_network.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.social_network.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.social_network.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.social_network.new')"
            :new-title="__('catalog.social_network.new_title')"
            :edit-title="__('catalog.social_network.edit_title')"
            :create="__('catalog.social_network.create')"
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.social_network.fields.abbreviation')"
                    name="abbreviation"
                    :hint="__('catalog.social_network.fields.abbreviation_hint')"
                    maxlength="10"
                    alpine-error="abbreviation"
                    wire:model="form.data.abbreviation"
                />

                <x-inputsform.input
                    span="text"
                    :label="__('catalog.social_network.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.social_network.fields.name_placeholder')"
                    alpine-error="name"
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="long"
                    :label="__('catalog.social_network.fields.url')"
                    required
                    name="url"
                    type="url"
                    :hint="__('catalog.social_network.fields.url_hint')"
                    maxlength="255"
                    alpine-error="url"
                ...
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.social_network.fields.icon')"
                    name="icon"
                    :placeholder="__('catalog.social_network.fields.icon_placeholder')"
                    :hint="__('catalog.social_network.fields.icon_hint')"
                ...
                <x-inputsform.switch-field
                    span="text"
                    :label="__('catalog.social_network.fields.status')"
                    name="is_active"
                    :on="__('catalog.social_network.status.active')"
