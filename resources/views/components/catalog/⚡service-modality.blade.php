...
>
    ...
    <x-slot:list>
        <x-catalog.toolbar
            :search-placeholder="__('catalog.service_modality.search_placeholder')"
            :search-label="__('catalog.service_modality.search_label')"
            :singular="__('catalog.service_modality.singular')"
            :plural="__('catalog.service_modality.plural')"
            :create="__('catalog.service_modality.create')"
        />

        <x-catalog.table
            :empty="__('catalog.service_modality.empty')"
            :columns="[
        ...
        >
            ...
            <td>
                <span class="catalog-status" x-bind:class="row.active ? 'is-on' : 'is-off'">
                    <span class="dot"></span
                    ><span
                        x-text="row.active ? {{ \Illuminate\Support\Js::from(__('catalog.service_modality.status.active')) }} : {{ \Illuminate\Support\Js::from(__('catalog.service_modality.status.inactive')) }}"
                    ></span>
                </span>
            </td>
        </x-catalog.table>
    ...
    <x-slot:form>
        <x-catalog.form-shell
            :new="__('catalog.service_modality.new')"
        ...
        >
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.service_modality.fields.code')"
                    required
                    name="code"
                    :hint="__('catalog.service_modality.fields.code_hint')"
                    maxlength="30"
                    alpine-error="code"
                ...
                <x-inputsform.input
                    span="text"
                    :label="__('catalog.service_modality.fields.name')"
                    required
                    name="name"
                    :placeholder="__('catalog.service_modality.fields.name_placeholder')"
                    alpine-error="name"
            ...
            <x-catalog.form-row>
                <x-inputsform.input
                    span="long"
                    :label="__('catalog.service_modality.fields.description')"
                    name="description"
                    :placeholder="__('catalog.service_modality.fields.description_placeholder')"
                    :hint="__('catalog.service_modality.fields.description_hint')"
                    maxlength="255"
                ...
                <x-inputsform.combobox
                    span="text"
                    :label="__('catalog.service_modality.fields.icon')"
                    name="icon"
                    :placeholder="__('catalog.service_modality.fields.icon_placeholder')"
                    :hint="__('catalog.service_modality.fields.icon_hint')"
                ...
                <x-inputsform.input
                    span="code"
                    :label="__('catalog.service_modality.fields.order')"
                    name="sort_order"
                    type="number"
                    min="0"
                    max="32767"
                    :hint="__('catalog.service_modality.fields.order_hint')"
                ...
                <x-inputsform.switch-field
                    span="short"
                    :label="__('catalog.service_modality.fields.status')"
                    name="is_active"
                    :on="__('catalog.service_modality.status.active')"
                    :off="__('catalog.service_modality.status.inactive')"
