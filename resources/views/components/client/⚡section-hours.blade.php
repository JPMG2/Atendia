    ...
    <div class="bp-hours">
        @foreach ([1, 2, 3, 4, 5, 6, 0] as $day)
            <div wire:key="day-{{ $day }}" @class(['bp-hrow', 'is-closed' => $form->week[$day] === []])>
                ...
                <x-ui.switch name="day-{{ $day }}" size="sm" :checked="$form->week[$day] !== []"
                    ...
                    @forelse ($form->week[$day] as $index => $shift)
                        <span class="bp-shift-edit" wire:key="shift-{{ $day }}-{{ $index }}">
                            ...
                            <x-inputsform.input type="text" size="s" maxlength="5" inputmode="numeric"
                                ...
                                class="font-mono" wire:model="form.week.{{ $day }}.{{ $index }}.opens_at" />
                            ...
                            <x-inputsform.input type="text" size="s" maxlength="5" inputmode="numeric"
                                ...
                                class="font-mono" wire:model="form.week.{{ $day }}.{{ $index }}.closes_at" />
