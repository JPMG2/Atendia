@php
    // Only businesses that consented to be named (design rule §6), and the
    // strip stays hidden until three of them exist — same bar as the carousel.
    $clients = \App\Models\Testimonial::published()->pluck('display_name')->unique()->values();
@endphp
