...
return [
    ...
    */
    ...
    // Boost 2.10 moved Claude Code's guidelines to AGENTS.md, which Claude Code
    // never reads (and which holds the hand-written Codex brief): CLAUDE.md
    // silently froze on 2026-09-24 and new golden rules never reached it.
    'agents' => [
        'claude_code' => [
