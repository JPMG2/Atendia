...
return [
    ...
    'services' => [
        ...
        'sheet_title' => 'Ficha de :name',
        'sheet_hint' => 'Todo lo que cargues aquí, tu asistente lo responde en WhatsApp.',
        'field_name' => 'Nombre',
        'field_minutes' => 'Duración (min)',
        'field_price_type' => 'Precio',
        'price_fixed' => 'Fijo',
        'price_from' => 'Desde',
        'price_free' => 'Gratis',
        'price_talk' => 'A convenir',
        'field_amount' => 'Monto',
        'field_deposit' => 'Seña',
        'deposit_help' => 'Tu asistente la cobra por Mercado Pago al agendar.',
        'field_description' => 'Descripción',
        'description_help' => 'Le da contexto a tu asistente para responder preguntas abiertas.',
        'field_prep' => 'Preparación',
        'prep_help' => 'Lo que el cliente debe saber o traer: tu asistente lo avisa al agendar.',
        'offered' => 'Tu asistente lo ofrece',
        'sheet_cancel' => 'Cancelar',
        'sheet_save' => 'Guardar servicio',
    ],
    ...
    'products' => [
        ...
        'state_review' => 'Revisando import',
        'edit' => 'Editar :name',
        'waiting' => '{1} :count esperando aviso|[2,*] :count esperando aviso',
        'out_note' => 'Sin stock: tu asistente lo dice y ofrece avisar cuando vuelva.',
        'review_summary' => ':rows filas leídas',
        'review_ok' => ':count listas',
        'review_errors' => ':count con error',
        'review_only_errors' => 'Ver solo errores',
        'review_bad_price' => 'El precio no es un número: corrígelo y la fila entra.',
        'review_no_name' => 'La fila :row vino sin nombre: complétala o descártala.',
        'review_dupe' => 'Ya existe en tu lista: si confirmas, actualiza el precio.',
        'review_fix' => 'Guardar fila',
        'review_drop' => 'Descartar fila',
        'review_edit' => 'Editar fila',
        'review_note' => 'Las filas con error no entran; puedes confirmar las demás y arreglarlas después.',
        'review_discard' => 'Descartar todo',
        'review_confirm' => 'Confirmar :count productos',
    ],
