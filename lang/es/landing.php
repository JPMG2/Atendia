...
return [
    ...
    'pricing' => [
        ...
        'calculator' => [
            ...
            'subtitle' => 'Mueve el control con las consultas de un día normal.',
            'slider_label' => 'Consultas que recibes por día',
            'formula_per_day' => 'por día × 30 días =',
            'formula_month' => 'consultas al mes',
            'today_tag' => 'Hoy, a mano',
            'hour_value_label' => '¿Cuánto vale una hora tuya? (USD)',
            'today_lead' => 'al mes respondiendo mensajes.',
            'today_cost' => 'Te cuesta :amount al mes.',
            'with_cost' => 'Plan :plan: :amount al mes.',
            'days_one' => 'Es un día entero de trabajo.',
