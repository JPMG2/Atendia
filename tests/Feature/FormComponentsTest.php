...
|--------------------------------------------------------------------------
*/
test('the input renders a label, control and field, deriving the id from the name', function () {
...
test('the input shows an error and switches the control to the error state', function () {
    $html = Blade::render('<x-ui.input name="email" error="Required" />');

    expect($html)->toContain('field-error')->toContain('Required');
});

test('the input forwards attributes like placeholder and wire:model to the control', function () {
...
test('the input renders a left icon when given one', function () {
...
|--------------------------------------------------------------------------
*/
test('the textarea renders its slot as content', function () {
...
test('the select builds options from an associative array and a placeholder', function () {
...
|--------------------------------------------------------------------------
*/
test('the switch renders a checkbox with the switch role and reflects checked', function () {
...
test('the checkbox renders a title and description and aligns to top with a description', function () {
...
|--------------------------------------------------------------------------
*/
test('the avatar falls back to initials and is deterministic per name', function () {
...
test('the avatar renders a status dot when given a status', function () {
...
|--------------------------------------------------------------------------
*/
test('the alert applies its variant class and can be dismissible via Alpine', function () {
...
test('an invalid alert variant falls back to info', function () {
...
|--------------------------------------------------------------------------
*/
test('the stat card renders label, value and a trend arrow with its delta', function () {
...
|--------------------------------------------------------------------------
*/
test('the tabs render a button per tab and start on the default', function () {
...
|--------------------------------------------------------------------------
*/
test('form and data components theme themselves through tokens, no hardcoded hex', function () {
    foreach ([
